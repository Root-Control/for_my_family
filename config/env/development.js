...
module.exports = {
  ...
  mailer: {
    from: process.env.MAILER_FROM || 'Hiro',
    options: {
      service: process.env.MAILER_SERVICE_PROVIDER || 'gmail',
      auth: {
        user: process.env.MAILER_EMAIL_ID || 'l2oot.control@gmail.com',
        pass: process.env.MAILER_PASSWORD || 'Secretsystem1@'
      },
